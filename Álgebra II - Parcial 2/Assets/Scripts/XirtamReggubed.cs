...
public class XirtamReggubed : EditorWindow
{
	public GameObject target;
	GUIStyle style = new GUIStyle();
	[MenuItem("Window/XirtamReggubed")]
	static void Init()
	{
		XirtamReggubed window = (XirtamReggubed)EditorWindow.GetWindow(typeof(XirtamReggubed));
		window.Show();
	}
